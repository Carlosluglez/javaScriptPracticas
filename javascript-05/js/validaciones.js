...
function calcularCodigoControl() {
    let banco =  document.querySelector('[name="codigo_banco"]').value;
    let sucursal = document.querySelector('[name="codigo_oficina"]').value;
    let cuenta = document.querySelector('[name="numero_cuenta"]').value;
...
function numerosPositive() {
    let cadena_errores = "";
    let camposPositivos = [document.querySelector('[name="telefono"]').value, document.querySelector('[name="codigo_postal"]').value];
...
function validarTipoEmpresaTipoPersona() {
    let botonbien = true;
    let cadena_errores = "";
    let tipo_empresa=document.querySelector('input[name="tipo"]:checked');
    let tipo_persona=document.querySelector('input[name="radios"]:checked');
    let cajaError_tipo_empresa=document.getElementById("error_tipo_empresa");
    let cajaError_tipo_persona=document.getElementById("error_tipo_persona");
    
    if (!tipo_empresa) {
        botonbien = false;
        cadena_errores += "Es obligatorio elegir una opción de tipo de empresa\n ";
        cajaError_tipo_empresa.value = cadena_errores;
        cajaError_tipo_empresa.style.visibility = "visible";
       // document.formulario.error_tipo_empresa.style.border = "1px solid black";
    } else {
        cajaError_tipo_empresa.style.visibility = "hidden";
    }

    if (!tipo_persona) {
        botonbien = false;
        cadena_errores += "Es obligatorio elegir una opción tipo de persona\n ";
        cajaError_tipo_persona.value = cadena_errores;
        cajaError_tipo_persona.style.visibility = "visible";
      //  document.formulario.error_tipo_persona.style.border = "1px solid black";
    } else {
        cajaError_tipo_persona.style.visibility = "hidden";
    }
...
function validarOpction() {
    ...
    contador = 0;
    let cadena_errores = "";
    let comunidades = document.querySelector('select[name="comunidades"]');
    ...
    if (contador < 2) {
        ...
        document.querySelector('[name="error_comunidades"]').value = cadena_errores;
        document.querySelector('[name="error_comunidades"]').style.visibility = "visible";
      //  document.formulario.error_comunidades.style.border = "1px solid black";
    }else{
        document.querySelector('[name="error_comunidades"]').style.visibility = "hidden";
    }
...
function validarSectorEconomico() {
    ...
    let botonbien = true;
    let cadena_errores = "";
    let sector = document.querySelectorAll('input[type="checkbox"]');
    let contador = 0;
    ...
    if (contador < 2) {
        ...
        document.querySelector('[name="error_sector_economico"]').value = cadena_errores;
        document.querySelector('[name="error_sector_economico"]').style.visibility = "visible";
      //  document.formulario.error_sector_economico.style.border = "1px solid black";
        botonbien = false;
    } else {
        document.querySelector('[name="error_sector_economico"]').style.visibility = "hidden";
    }
    return botonbien;
}
...
function validarNumeroCuenta() {
    let cadena_errores = "";
    let numeroCuenta = document.querySelector('name="numero_cuenta"').value;
